...
export default defineConfig({
    ...
    preflights: [
        {
            getCSS: () => `
                ...
                .fade-in-visible, .fade-in-invisible {
    ...
    shortcuts: {
        ...
        'filter-btn': 'bg-primary-50 hover:bg-primary-60 border-none px-2.3 py-1.8 rounded-lg cursor-pointer',

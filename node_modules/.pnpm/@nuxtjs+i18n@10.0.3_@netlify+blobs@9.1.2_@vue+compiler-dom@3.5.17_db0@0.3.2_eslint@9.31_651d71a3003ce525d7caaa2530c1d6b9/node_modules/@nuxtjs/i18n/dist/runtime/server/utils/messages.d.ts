 ...
 */
export declare const getMergedMessages: (locale: string, fallbackLocales: string[]) => Promise<LocaleMessages<DefineLocaleMessage>>;
export declare const getAllMergedMessages: (locales: string[]) => Promise<LocaleMessages<DefineLocaleMessage>>;

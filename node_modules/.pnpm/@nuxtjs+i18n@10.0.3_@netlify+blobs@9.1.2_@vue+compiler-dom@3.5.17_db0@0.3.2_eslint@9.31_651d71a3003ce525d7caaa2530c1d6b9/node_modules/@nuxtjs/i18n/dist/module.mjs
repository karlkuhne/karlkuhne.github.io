import { useLogger, resolvePath, useNuxt, directoryToURL, resolveModule, addTemplate, updateTemplates, tryUseNuxt, addBuildPlugin, addServerTemplate, addServerImports, addServerPlugin, addServerHandler, createResolver, addPlugin, addVitePlugin, useNitro, addTypeTemplate, addComponent, addImports, defineNuxtModule } from '@nuxt/kit';
...
function getRouteOptions(route, localeCodes, ctx, defaultLocale, mode = "config") {
  ...
  if (mode === "config") {
    ...
    resolvedOptions = getRouteFromResource(
      localeCodes,
      mode === "page" ? readComponent(route.file) : route.meta?.i18n
    );
  }
...
function readComponent(target) {
  try {
    ...
    console.warn(`[nuxt-i18n] Couldn't read component data at ${target}: (${e.message})`);
  }
  return void 0;
}
